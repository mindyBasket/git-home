  	...
  	projects: [
  		{
  			...
  			shortSummary: "STEM course content delivery platform that uses VEX. Involved in web development, course development and deployment.",
  			tags: [
  				"Javascript",
				"PHP",
				"Node.js",
  		...
  		,
  		{
  			img: "",
  			title: "Flipbook",
  			shortSummary: "Editor that generates sharable 'flipbooks', an alternative story telling format that is somewhere between an animated movie and a storyboard.",
  			tags: [
  				"ReactJS",
  				"Django",
  				"RESTful framework",
  		...
  		,
  		{
  			...
  			title: "CS2N",
  			shortSummary: "Involved in second iteration of Badge system. Including system that reward different tiers of badge and ways to display and share. Logic parser for interpreting trigger rule.",
  			tags: [
  				"Ruby on Rails",
  				"Javascript",
  				"mySQL",
  		...
  		,
  		{
  			...
  			shortSummary: "A family of lightweight, standalone curriculum sites. Made everything on it, from web dev, interactive widgets, course video and graphics",
  			tags: [
  				"Javascript",
  				"bootstrap",
  			],
  		...
  		},
  		{
  			img: "",
  			title: "Sandbloqs",
  			shortSummary: "Extended Google's Blockly to have 'Object' type. Intended to teach object oriented programming language.",
  			tags: [
  				"Javascript",
  				"Phaser",
  				"NW.js",
...

  		{
  			...
  			shortSummary: "Madcap is a documentation program that we extended its usage to behave like Moodle. Javascript was used to fill the gap between desired UI/UX functionality to what Madcap can offer.",
  			tags: [
  				"Javascript",
  			],
  			longSummary: `Morbi elementum facilisis hendrerit. Nam ullamcorper tristique nisi lobortis pulvinar. Proin eu sapien quis elit blandit tincidunt id eu arcu. Vestibulum vestibulum magna cursus ex luctus, ac efficitur felis porttitor. Mauris consectetur aliquet tortor ac sollicitudin. Proin nec tempor lorem. Nam a varius diam. Pellentesque feugiat dictum lacinia. Curabitur quis viverra sapien, sit amet accumsan lorem. Praesent orci ipsum, aliquam in lectus a, laoreet mattis mi. Morbi mollis dolor lacus, eu pulvinar dolor posuere non. `
