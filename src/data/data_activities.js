  ...
  data: [
    {
      ...
      description: `Participated in Global Game Jams in Pittsburgh with a <strong>duel role</strong>
       ...
       <ul>
        <li><strong>"Visual Excellence Award"</strong> in 2018 with 
        <a href="https://globalgamejam.org/2018/games/apollo-god-birds" target="_blank">Apollo: God of Birds <span class="fas fa-external-link-square-alt"/></a>
       </li>
       <li><strong>"Non-traditional Award"</strong> in 2019 with 
       <a href="https://globalgamejam.org/2019/games/bitter-sweet" target="_blank">Bitter Sweet <span class="fas fa-external-link-square-alt"/></li>
       </ul>`
    },
    {
